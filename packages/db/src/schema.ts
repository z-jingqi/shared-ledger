...
export const importJobs = sqliteTable(
  "import_jobs",
  {
    ...
    duplicateOfImportJobId: text("duplicate_of_import_job_id"),
  ...
  (t) => [
    index("import_jobs_file_hash").on(t.bookId, t.fileHash),
    index("import_jobs_ocr_text_hash").on(t.bookId, t.ocrTextHash),
  ],
);
